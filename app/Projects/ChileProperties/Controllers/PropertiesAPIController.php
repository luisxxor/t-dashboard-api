...
class PropertiesAPIController extends AppBaseController
{
     ...
     *
     * @OA\Get(
     *     path="/api/chile_properties/filters/publication_type",
     ...
     *
     * @OA\Post(
     *     path="/api/chile_properties/search",
     ...
     *
     * @OA\Get(
     *     path="/api/chile_properties/paginate",
    ...
    public function generatePropertiesFile( Request $request )
    {
        ...
        try {
            ...
            $filesInfo[] = $this->googleStorageHandler->uploadFile( config( 'app.cl_export_file_bucket' ), $path, $order->total_rows_quantity );
